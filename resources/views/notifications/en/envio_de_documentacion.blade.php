	...
	<div class="row">
		<div class="col-12" style="margin-top:30px; width: 80%;">
	        ...
	        @if(isset($data['ESTATUS']) && $data['ESTATUS'] == 'rejected')
	        	<p>Your request for <b class="font-600">document delivery</b> was rejected. With following information</p>
	        @elseif(isset($data['ESTATUS']) && $data['ESTATUS'] == 'approved')
	        	<p>Your request for <b class="font-600">document delivery</b> was approved. With following information</p>
	        @else
	        	<p>Your request for <b class="font-600">document delivery</b> have been recived. With following information</p>
	        @endif
			...
			<div style="width: 100%;">
				<div style="width: 50%; float: left;">
					<p><b class="font-600">DOCUMENT TYPE: </b> {{ isset($data['DOCUMENT_TYPE']) ? $data['DOCUMENT_TYPE'] : '-' }}</p>
				</div>
			</div>
			<div style="clear: both;"></div>
