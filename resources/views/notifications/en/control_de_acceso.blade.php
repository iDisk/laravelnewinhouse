	...
	<div class="row">
	    <div class="col-12" style="margin-top:30px;">
	        ...
	        @if(isset($data['ESTATUS']) && $data['ESTATUS'] == 'rejected')
	        	<p>Your request to change <b class="font-600">Access control</b> was rejected.</p>
	        @elseif(isset($data['ESTATUS']) && $data['ESTATUS'] == 'approved')
	        	<p>Your request to change <b class="font-600">Access control</b> was approved.</p>
	        @else
	        	<p>Your request to change <b class="font-600">Access control</b> has been received.</p>
	        @endif
