	...
	<div class="row">
		<div class="col-12" style="margin-top:30px; width: 80%;">
	        ...
	        @if(isset($data['ESTATUS']) && $data['ESTATUS'] == 'rejected')
	        	<p>Your request for <b class="font-600">Transfer between the same broker</b> was rejected. With following information</p>
	        @elseif(isset($data['ESTATUS']) && $data['ESTATUS'] == 'approved')
	        	<p>Your request for <b class="font-600">Transfer between the same broker</b> was approved. With following information</p>
	        @else
	        	<p>Your request for <b class="font-600">Transfer between the same broker</b> have been recived. With following information</p>
	        @endif
