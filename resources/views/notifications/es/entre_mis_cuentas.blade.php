	...
	<div class="row">
		<div class="col-12" style="margin-top:30px; width: 80%;">
	        ...
	        @if(isset($data['ESTATUS']) && $data['ESTATUS'] == 'rejected')
	        	<p>Su solicitud de <b class="font-600">transferencias entre mis cuentas</b> fue rechazada. Con la siguiente información</p>
	        @elseif(isset($data['ESTATUS']) && $data['ESTATUS'] == 'approved')
	        	<p>Su solicitud de <b class="font-600">transferencias entre mis cuentas</b> fue aprobada. Con la siguiente información</p>
	        @else
	        	<p>Su solicitud de <b class="font-600">transferencias entre mis cuentas</b> ha sido recibida. Con la siguiente información.</p>
	        @endif
