	...
	<div class="row">
	    <div class="col-12" style="margin-top:30px;">
	        ...
	        @if(isset($data['ESTATUS']) && $data['ESTATUS'] == 'rejected')
	        	<p>Su solicitud para cambiar <b class="font-600">Datos Personales</b> fue rechazada.</p>
	        @elseif(isset($data['ESTATUS']) && $data['ESTATUS'] == 'approved')
	        	<p>Su solicitud para cambiar <b class="font-600">Datos Personales</b> fue aprobada.</p>
	        @else
	        	<p>Su solicitud para cambiar <b class="font-600">Datos Personales</b> ha sido recibida.</p>
	        @endif
