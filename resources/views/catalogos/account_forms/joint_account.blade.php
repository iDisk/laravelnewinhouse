<div class="client_personal_info">
    <h4 class="m-b-30 m-t-30 header-title"><b>@lang('sistema.client.account_holder_information') (1)</b><hr></h4>
...
<div class="client_personal_info">
    <h4 class="m-b-30 m-t-30 header-title"><b>@lang('sistema.client.account_holder_information') (2)</b><hr></h4>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.first_name')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
    ...
    <div class="form-group col-lg-12 row">
        ...
        <div class="form-group col-lg-6 row m-0" id="inputbranch_id">
            <label for="branch_id2" class="col-sm-3 form-control-label">@lang('sistema.branches.branches')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <select class="form-control" id="branch_id2" name="client[branch_id][]" valida="SI" cadena ="{{__('sistema.branches.req_branch')}}">
                    <option value="">@lang('sistema.branches.select_branch')</option>
                    @if(isset($branches) && count($branches)>0)
                    @foreach($branches as $branch_id => $branch_name)
                    <option value="{{ $branch_id }}" {{ old('branch_id') == $branch_id ? 'selected' : '' }}>{{ $branch_name }}</option>
