<div class="client_personal_info">
    ...
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[registered_name]" placeholder="{{__('sistema.client.registered_name')}}" valida="SI" cadena ="{{__('sistema.client.registered_name_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.type_of_entity')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[business_type]" placeholder="{{__('sistema.client.type_of_entity')}}" valida="SI" cadena ="{{__('sistema.client.type_of_entity_valid')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[authorised_signatories1]" placeholder="{{__('sistema.client.authorised_signatories1')}}" valida="SI" cadena ="{{__('sistema.client.authorised_signatories1_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.authorised_signatories2')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[authorised_signatories2]" placeholder="{{__('sistema.client.authorised_signatories2')}}" valida="SI" cadena ="{{__('sistema.client.authorised_signatories2_valid')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[registration_number]" placeholder="{{__('sistema.client.registration_number')}}" valida="SI" cadena ="{{__('sistema.client.registration_number_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.incorporation_date')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control date_picker" name="business_detail[incorporation_date]" placeholder="{{__('sistema.client.incorporation_date')}}" valida="SI" cadena ="{{__('sistema.client.incorporation_date_valid')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[incorporation_place]" placeholder="{{__('sistema.client.incorporation_place')}}" valida="SI" cadena ="{{__('sistema.client.incorporation_place_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
    ...
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[address]" placeholder="{{__('sistema.client.entity_address')}}" valida="SI" cadena ="{{__('sistema.client.entity_address_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.entity_county')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[county]" placeholder="{{__('sistema.client.entity_county')}}" valida="SI" cadena ="{{__('sistema.client.entity_county_valid')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[zip_code]" placeholder="{{__('sistema.client.entity_zip_code')}}" valida="SI" cadena ="{{__('sistema.client.entity_zip_code_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0" id="inputbranch_id">
            ...
            <div class="col-sm-9">
                <select class="form-control" id="branch_id" name="business_detail[branch_id]" valida="SI" cadena ="{{__('sistema.branches.req_branch')}}">
    ...
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[industry_type]" placeholder="{{__('sistema.client.entity_industry_type')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.entity_employees')</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[employees]" placeholder="{{__('sistema.client.entity_employees')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[webiste]" placeholder="{{__('sistema.client.entity_webiste')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control inttel_input" name="business_detail[telephone1]" placeholder="{{__('sistema.client.entity_telephone1')}}" valida="SI" cadena ="{{__('sistema.client.entity_telephone1_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.entity_telephone2')</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[telephone2]" placeholder="{{__('sistema.client.entity_telephone2')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="business_detail[telephone3]" placeholder="{{__('sistema.client.entity_telephone3')}}" value="">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control valid_email" name="business_detail[email1]" placeholder="{{__('sistema.client.entity_email1')}}" valida="SI" cadena ="{{__('sistema.client.entity_email1_valid')}}" value="">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.entity_email2')</label>
            <div class="col-sm-9">
                <input type="text" class="form-control valid_email" name="business_detail[email2]" placeholder="{{__('sistema.client.entity_email2')}}" value="">
            </div>
        </div>
    </div>
</div>
<div class="client_personal_info">
    <h4 class="m-b-30 m-t-30 header-title"><b>@lang('sistema.client.head_authorised_signatories') (1)</b><hr></h4>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
    ...
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="file" class="form-control filestyle" name="national_identity_file[]"  data-buttonname="btn-info" data-buttontext="{{__('sistema.btn_choose_file')}}" placeholder="{{__('sistema.client.national_identity_file')}}" value="{{ old('national_identity_file') }}" valida="SI" cadena ="{{__('sistema.client.national_identity_file_valid')}}">
            </div>
        </div>
    </div>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control dob" name="client[dob][]" placeholder="{{__('sistema.client.dob')}}" valida="SI" cadena ="{{__('sistema.client.dob_valid')}}" value="{{ old('dob') }}">
            </div>
        </div>
        <div class="form-group col-lg-6 row m-0">
...
<div class="client_personal_info">
    <h4 class="m-b-30 m-t-30 header-title"><b>@lang('sistema.client.head_authorised_signatories') (2)</b><hr></h4>
    <div class="form-group col-lg-12 row">
        <div class="form-group col-lg-6 row m-0">
            <label class="col-sm-3 form-control-label">@lang('sistema.client.first_name')<span class="text-danger">*</span></label>
            <div class="col-sm-9">
