                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @endif
                            <form class="form-horizontal"  method="POST" action="{{url('brands')}}" id="frm_items" onsubmit="return validateFrm();" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="form-group row" id="inputbroker">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="broker" name="broker" placeholder="{{__('sistema.broker.broker')}}" valida="SI" cadena ="{{__('sistema.broker.required.req_broker')}}" value="{{ old('broker') ? : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputcolor">
                                            ...
                                            <div class="col-sm-8">
                                                <div data-color-format="rgb" data-color="#ffffff" class="colorpicker-default input-group">
                                                    <input type="text" value="" name="color" id="color" class="form-control color_input" valida="SI" cadena ="{{__('sistema.broker.required.req_account_color')}}" value="{{ old('color') ? : '#ffffff' }}">
                                            ...
                                            <!--                                            <div id="legend_color_picker2" class="col-sm-8 input-group colorpicker-component">
                                                                                            <input type="text" class="form-control colorpicker" valida="SI" name="color" id="color" placeholder="{{__('sistema.broker.account_color')}}" cadena ="{{__('sistema.broker.required.req_account_color')}}" value="{{ old('color') ? : '#f5cba2' }}"/>
                                        ...
                                        <div class="form-group row" id="inputcode">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" valida="SI" maxlength="5" name="code" id="code" placeholder="{{__('sistema.broker.account_code')}}" cadena="{{ __('sistema.broker.required.req_account_code') }}" value="{{ old('code') ? : '00000' }}"/>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputbroker_url">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" valida="SI" name="broker_url" id="broker_url" placeholder="{{__('sistema.broker.broker_url')}}" cadena="{{ __('sistema.broker.required.broker_url') }}" value="{{ old('broker_url') ? : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputdescription">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="description" id="description" placeholder="{{__('sistema.broker.description')}}" rows="10" valida="SI" cadena ="{{__('sistema.broker.required.req_description')}}">{{ old('description') ? : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>   
                                ...
                                <div class="row">                                    
                                    <div class="col-lg-8">
                                        <fieldset style="border: 1px solid #ccc;padding: 10px;">
                                            <legend style="font-size: 16px;">&nbsp;@lang('sistema.configuration.charges')</legend>
                                            <div class="form-group row" id="inputtransfer_commission_percentage">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="autonumber2 form-control" type="text" id="transfer_commission_percentage" name="transfer_commission_percentage" value="{{ old('transfer_commission_percentage') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.transfer_commission_percentage')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputtransfer_commission_amount">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="autonumber form-control" type="text" id="transfer_commission_amount" name="transfer_commission_amount" value="{{ old('transfer_commission_amount') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.transfer_commission_amount')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputprocessing_fees_percentage">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="autonumber2 form-control" type="text" id="processing_fees_percentage" name="processing_fees_percentage" value="{{ old('processing_fees_percentage') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.processing_fees_percentage')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputprocessing_fees_amount">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="autonumber form-control" type="text" id="processing_fees_amount" name="processing_fees_amount" value="{{ old('processing_fees_amount') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.processing_fees_amount')}}"/>
                                                </div>
                                            </div>
                                            <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <fieldset style="border: 1px solid #ccc;padding: 10px;">
                                            ...
                                            <div class="form-group row" id="inputcontact_number">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" id="contact_number" name="contact_number" value="{{ old('contact_number') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.contact_number')}}" />
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputwebsite_url">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" id="website_url" name="website_url" value="{{ old('website_url') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.website_url')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputsupport_team_email">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="email" id="support_team_email" name="support_team_email" value="{{ old('support_team_email') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.support_team_email')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputadmin_email">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="email" id="admin_email" name="admin_email" value="{{ old('admin_email') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.admin_email')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputadmin_name">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" maxlength="30" id="admin_name" name="admin_name" value="{{ old('admin_name') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.admin_name')}}"/>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group row" id="inputstatement_legend">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" maxlength="30" type="text" id="statement_legend" name="statement_legend" value="{{ old('statement_legend') ? : '' }}" valida="SI" cadena ="{{__('sistema.configuration.required.statement_legend')}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputstatement_legend_color">
                                                ...
                                                <div class="col-sm-8">
                                                    <div data-color-format="rgb" data-color="#ffffff" class="colorpicker-default input-group">
                                                        <input type="text" value="{{ old('statement_legend_color') ? : '#ffffff' }}" name="statement_legend_color" id="statement_legend_color" class="form-control color_input" valida="SI" cadena ="{{__('sistema.configuration.required.statement_legend_color')}}">
                                                        <span class="input-group-append add-on color_button">
                                                            <button class="btn btn-white" type="button">
                                                                <i style="background-color: #ffffff;margin-top: 2px;"></i>
                                                            </button>
                                                ...
                                                <!--                                                <div id="legend_color_picker" class="col-sm-8 input-group colorpicker-component">
                                                                                                    <input type="text" name="statement_legend_color" id="statement_legend_color" class="form-control" value="{{ old('statement_legend_color') ? : '#007bff' }}" valida="SI" cadena ="{{__('sistema.configuration.required.statement_legend_color')}}"/>
                                                                                                    <span class="input-group-addon"><i></i></span>
                                                                                                </div>-->
                                            ...
                                            <div class="form-group row" id="inputdisclaimer_es">
                                                <label class="col-sm-12 form-control-label">@lang('sistema.configuration.disclaimer_es')<span class="text-danger">*</span></label>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="disclaimer_es" id="disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.disclaimer_es')}}">{{ old('disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputdisclaimer_en">
                                                <label class="col-sm-12 form-control-label">@lang('sistema.configuration.disclaimer_en')<span class="text-danger">*</span></label>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="disclaimer_en" id="disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.disclaimer_en')}}">{{ old('disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group row" id="inputmenu_orientation">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="custom-control custom-radio custom-control-inline mb-2">
                                                        <input type="radio" id="menu_orientation_vertical" name="menu_orientation" value="vertical" class="custom-control-input">
                                                        <label class="custom-control-label" for="menu_orientation_vertical">Vertical</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mb-2">
                                                        <input type="radio" id="menu_orientation_horizontal" name="menu_orientation" value="horizontal" class="custom-control-input" checked="">
                                            ...
                                            <div class="form-group row" id="inputfooter_privacy_policy_es" >
                                                ...
                                                <div class="col-sm-12">     
                                                    <textarea class="form-control summernote" name="footer_privacy_policy_es" id="footer_privacy_policy_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_privacy_policy_es')}}">{{ old('footer_privacy_policy_es') ? : '' }}</textarea>
                                                </div>
                                            </div>                                           
                                            <div class="form-group row" id="inputfooter_privacy_policy_en" >
                                                ...
                                                <div class="col-sm-12">     
                                                    <textarea class="form-control summernote" name="footer_privacy_policy_en" id="footer_privacy_policy_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_privacy_policy_en')}}">{{ old('footer_privacy_policy_en') ? : '' }}</textarea>
                                                </div>
                                            </div>                                           
                                            <div class="form-group row" id="inputfooter_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="footer_tnc_es" id="footer_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_tnc_es')}}">{{ old('footer_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfooter_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="footer_tnc_en" id="footer_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_tnc_en')}}">{{ old('footer_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfooter_privacy_notice_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="footer_privacy_notice_es" id="footer_privacy_notice_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_privacy_notice_es')}}">{{ old('footer_privacy_notice_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfooter_privacy_notice_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="footer_privacy_notice_en" id="footer_privacy_notice_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.footer_privacy_notice_en')}}">{{ old('footer_privacy_notice_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputinternational_transfer_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="international_transfer_disclaimer_es" id="international_transfer_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.international_transfer_disclaimer_es')}}">{{ old('international_transfer_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputinternational_transfer_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="international_transfer_disclaimer_en" id="international_transfer_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.international_transfer_disclaimer_en')}}">{{ old('international_transfer_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfinancing_request_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="financing_request_disclaimer_es" id="financing_request_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.financing_request_disclaimer_es')}}">{{ old('financing_request_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfinancing_request_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="financing_request_disclaimer_en" id="financing_request_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.financing_request_disclaimer_en')}}">{{ old('financing_request_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfinancing_request_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="financing_request_tnc_es" id="financing_request_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.financing_request_tnc_es')}}">{{ old('financing_request_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputfinancing_request_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="financing_request_tnc_en" id="financing_request_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.financing_request_tnc_en')}}">{{ old('financing_request_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputexpand_financing_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="expand_financing_disclaimer_es" id="expand_financing_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.expand_financing_disclaimer_es')}}">{{ old('expand_financing_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputexpand_financing_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="expand_financing_disclaimer_en" id="expand_financing_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.expand_financing_disclaimer_en')}}">{{ old('expand_financing_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputexpand_financing_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="expand_financing_tnc_es" id="expand_financing_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.expand_financing_tnc_es')}}">{{ old('expand_financing_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputexpand_financing_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="expand_financing_tnc_en" id="expand_financing_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.expand_financing_tnc_en')}}">{{ old('expand_financing_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputrefinancing_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="refinancing_disclaimer_es" id="refinancing_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.refinancing_disclaimer_es')}}">{{ old('refinancing_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputrefinancing_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="refinancing_disclaimer_en" id="refinancing_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.refinancing_disclaimer_en')}}">{{ old('refinancing_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccess_control_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="access_control_tnc_es" id="access_control_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.access_control_tnc_es')}}">{{ old('access_control_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccess_control_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="access_control_tnc_en" id="access_control_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.access_control_tnc_en')}}">{{ old('access_control_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccounts_administration_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="accounts_administration_tnc_es" id="accounts_administration_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.accounts_administration_tnc_es')}}">{{ old('accounts_administration_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccounts_administration_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="accounts_administration_tnc_en" id="accounts_administration_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.accounts_administration_tnc_en')}}">{{ old('accounts_administration_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputadjust_permission_tnc_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="adjust_permission_tnc_es" id="adjust_permission_tnc_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.adjust_permission_tnc_es')}}">{{ old('adjust_permission_tnc_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputadjust_permission_tnc_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="adjust_permission_tnc_en" id="adjust_permission_tnc_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.adjust_permission_tnc_en')}}">{{ old('adjust_permission_tnc_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputsend_documentation_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="send_documentation_disclaimer_es" id="send_documentation_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.send_documentation_disclaimer_es')}}">{{ old('send_documentation_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputsend_documentation_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="send_documentation_disclaimer_en" id="send_documentation_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.send_documentation_disclaimer_en')}}">{{ old('send_documentation_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccount_registration_disclaimer_es" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="account_registration_disclaimer_es" id="account_registration_disclaimer_es" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.account_registration_disclaimer_es')}}">{{ old('account_registration_disclaimer_es') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row" id="inputaccount_registration_disclaimer_en" >
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control summernote" name="account_registration_disclaimer_en" id="account_registration_disclaimer_en" style="resize: vertical;" valida="SI" cadena ="{{__('sistema.configuration.required.account_registration_disclaimer_en')}}">{{ old('account_registration_disclaimer_en') ? : '' }}</textarea>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-4" style="margin-top: 12px;">
                                        <div class="form-group row">                                
                                            <div class="col-sm-8">
                                                <img id="img_cat" style="width: 100%; border: 1px solid #ccc;" src="{{ asset(env('APP_ROOT').'/assets/images/no_image.png') }}" class="img-responsive"/>
...
<script type="text/javascript">
    ...
    var textarea_arr = ['disclaimer', 'footer_privacy_policy_es', 'footer_tnc_es', 'footer_privacy_notice_es',
        'international_transfer_disclaimer_es', 'financing_request_disclaimer_es',
        'financing_request_tnc_es', 'expand_financing_disclaimer_es', 'expand_financing_tnc_es',
        'refinancing_disclaimer_es', 'access_control_tnc_es', 'accounts_administration_tnc_es',
        'adjust_permission_tnc_es', 'send_documentation_disclaimer_es', 'account_registration_disclaimer_es'];
