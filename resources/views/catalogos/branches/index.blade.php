...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.branches.branches')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('branches/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.branches.new_branch')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="item-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.branches.branch_en')</th>
                                        <th>@lang('sistema.branches.branch_es')</th>
                                        <th>@lang('sistema.branches.country')</th>
...
<script type="text/javascript">
    ...
    $(function() {
        tbl_item = $('#item-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{!! url("datatable/branches") !!}',
                data: function (d) {
            ...
            columns: [
                { data: 'id', name: 'id' },
                { data: 'branch_en',name: 'branch_en'},
                { data: 'branch_es', name: 'branch_es'},
                { data: 'country_name', name: 'country_name'},
                { data: 'created_at', name: 'created_at'},
                { data: 'action', name: 'action', class: 'text-center', orderable:false, searchable:false, width: '10%' },
              ]
        });
    });
