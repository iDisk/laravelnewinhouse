    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.branches.create_branch')</h4>
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active">
                        @lang('sistema.branches.create_branch')
                    </li>
                </ol>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @endif
                            <form class="form-horizontal"  method="POST" action="{{url('branches')}}" id="frm_items" onsubmit="return validateFrm();" enctype="multipart/form-data">
                                ...
                                <div class="form-group row" id="inputbranch_en">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="branch_en" name="branch_en" placeholder="{{__('sistema.item.item_en')}}" valida="SI" cadena ="{{__('sistema.branches.req_branch_en')}}" value="{{ (old('branch_en'))? old('branch_en'):'' }}">
                                    </div>
                                </div>
                                <div class="form-group row" id="inputbranch_es">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="branch_es" name="branch_es" placeholder="{{__('sistema.item.item_es')}}" valida="SI" cadena ="{{__('sistema.branches.req_branch_es')}}" value="{{ (old('branch_es'))? old('branch_es'):'' }}">
                                    </div>
                                </div>
