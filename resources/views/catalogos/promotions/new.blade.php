        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p></p>
                    <form class="form-horizontal"  method="POST" action="{{url('brands/'. $broker->id .'/promotion')}}" id="frm_promotions" onsubmit="return validateFrm();" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-8">
                                @if (count($errors) > 0)
                                ...
                                <div class="form-group row" id="inputpromotion_title_en">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control frmfield" id="promotion_title_en" name="promotion_title_en" placeholder="{{__('sistema.promotions.promotion_title_en')}}" valida="SI" cadena ="{{__('sistema.promotions.required.promotion_title_en')}}" value="{{ (old('promotion_title_en')) ? : '' }}">
                                    </div>
                                </div>
                                <div class="form-group row" id="inputpromotion_title_es">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control frmfield" id="promotion_title_es" name="promotion_title_es" placeholder="{{__('sistema.promotions.promotion_title_es')}}" valida="SI" cadena ="{{__('sistema.promotions.required.promotion_title_es')}}" value="{{ (old('promotion_title_es')) ? : '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="inputpromotion_short_description_es">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" max="250" class="form-control frmfield" id="promotion_short_description_es" name="promotion_short_description_es" placeholder="{{__('sistema.promotions.promotion_short_description_es')}}" valida="SI" cadena ="{{__('sistema.promotions.required.promotion_short_description_es')}}" value="{{ (old('promotion_short_description_es')) ? : '' }}">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row" id="inputpromotion_long_description_en">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control frmfield" id="promotion_long_description_en" name="promotion_long_description_en" valida="SI" cadena ="{{__('sistema.promotions.required.promotion_long_description_en')}}" value="{{ (old('promotion_long_description_en')) ? : '' }}">{{ (old('promotion_long_description_en')) ? : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group row" id="inputpromotion_long_description_es">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control frmfield" id="promotion_long_description_es" name="promotion_long_description_es" valida="SI" cadena ="{{__('sistema.promotions.required.promotion_long_description_es')}}" value="{{ (old('promotion_long_description_es')) ? : '' }}">{{ (old('promotion_long_description_es')) ? : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row" id="inputestatus">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-radio custom-control-inline mb-2">
                                            <input type="radio" id="estatus_active" name="estatus" value="1" class="custom-control-input frmfield" checked>
                                            <label class="custom-control-label" for="estatus_active">@lang('sistema.active')</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline mb-2">
                                            <input type="radio" id="estatus_inactive" name="estatus" value="0" class="custom-control-input frmfield">
