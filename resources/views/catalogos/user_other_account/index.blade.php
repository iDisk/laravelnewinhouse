...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.alta_de_cuentas.title')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('user_other_accounts/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.alta_de_cuentas.new_btn')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="userOtherAccount-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.alta_de_cuentas.account_number')</th>
                                        <th>@lang('sistema.alta_de_cuentas.user')</th>
                                        <th>@lang('sistema.alta_de_cuentas.type_of_recipient')</th>
                                        <th>@lang('sistema.alta_de_cuentas.destination')</th>
...
@endif
    ...
    function confirmaDel(id,text)
    {
        swal({
            ...
            text: "{{ __('sistema.alta_de_cuentas.delete_msg') }} :\""+text+'\"?',
            type: "warning",
    ...
    $(function() {
        instrument_tbl = $('#userOtherAccount-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{!! url("datatable/user_other_accounts") !!}',
                data: function (d) {
            ...
            columns: [
                ...
                { data: 'type_of_recipient', name: 'type_of_recipient' },
