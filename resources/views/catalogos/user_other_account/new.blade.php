    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.alta_de_cuentas.create_page')</h4>
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active">
                        @lang('sistema.alta_de_cuentas.create_page')
                    </li>
                </ol>
          	...
          	<div class="card">
              	<div class="card-body">
                  	...
                  	<div class="row">
                        ...
                        <form class="form-horizontal"  method="POST" action="{{url('user_other_accounts')}}" id="frm_user_other_accounts" onsubmit="return validateFrm();" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="form-group col-lg-6 row m-0" >
                                  	...
                                  	<div class="col-sm-9 input_controls">
                                      	<select class="form-control" id="type_of_recipient" name="type_of_recipient" valida="SI" cadena="{{ __('sistema.alta_de_cuentas.type_of_recipient_err') }}">
                                        	<option value=""></option>
                                        	<option value="personal">@lang('sistema.alta_de_cuentas.personal')</option>
                                        	<option value="company">@lang('sistema.alta_de_cuentas.empresa')</option>
                                      	</select>
                                  	</div>
                                </div>
                                <div class="form-group col-lg-6 row m-0">
                                  	...
                                  	<div class="col-sm-9 input_controls">
                                      	<select class="form-control" id="destination_type" name="destination_type" valida="SI" cadena="{{ __('sistema.alta_de_cuentas.destination_error') }}">
                                        	<option value=""></option>
                                        	<option value="same">@lang('sistema.alta_de_cuentas.same_entity')</option>
                                        	<option value="international">@lang('sistema.alta_de_cuentas.international')</option>
                                      	</select>
                                  	</div>
                                </div>
                            </div>
