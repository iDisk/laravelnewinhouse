        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('sistema.instrument.edit_instrument')</h4>
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active">
                            @lang('sistema.instrument.edit_instrument')
                        </li>
                    </ol>
		         	...
		         	<div class="card-body">
		              	...
		              	<div class="row">
		                  	<div class="col-lg-6">
                                ...
                                @endif
		                  		<form class="form-horizontal"  method="POST" action="{{url('instruments/'.$instrument->id)}}" id="frm_instruments" onsubmit="return validateFrm();">
                                    ...
                                    <div class="form-group row" id="inputinstrument_en">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="instrument_en" name="instrument_en" placeholder="{{__('sistema.instrument.instrument_en')}}" valida="SI" cadena ="{{__('sistema.instrument.req_instrument_en')}}" value="{{ $instrument->instrument_en }}">
                                          </div>
                                    </div>
                                    <div class="form-group row" id="inputinstrument_es">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="instrument_es" name="instrument_es" placeholder="{{__('sistema.instrument.instrument_es')}}" valida="SI" cadena ="{{__('sistema.instrument.req_instrument_es')}}" value="{{ $instrument->instrument_es }}">
                                          </div>
                                    </div>
