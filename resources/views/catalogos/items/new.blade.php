	...
	<div class="row">
        <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('sistema.item.create_item')</h4>
                  	...
                  	<div class="row">
                      	<div class="col-lg-6">
                          	@if (count($errors) > 0)
                           	...
                           	@endif
                          	<form class="form-horizontal"  method="POST" action="{{url('items')}}" id="frm_items" onsubmit="return validateFrm();" enctype="multipart/form-data">
                          		...
                          		<div class="form-group row" id="inputitem_en">
                        	      	...
                        	      	<div class="col-sm-9">
                                      	<input type="text" class="form-control" id="item_en" name="item_en" placeholder="{{__('sistema.item.item_en')}}" valida="SI" cadena ="{{__('sistema.item.req_item_en')}}" value="{{ (old('item_en'))? old('item_en'):'' }}">
                                  	</div>
                              	</div>
                              	<div class="form-group row" id="inputitem_es">
                        	      	...
                        	      	<div class="col-sm-9">
                                      	<input type="text" class="form-control" id="item_es" name="item_es" placeholder="{{__('sistema.item.item_es')}}" valida="SI" cadena ="{{__('sistema.item.req_item_es')}}" value="{{ (old('item_es'))? old('item_es'):'' }}">
                                  	</div>
                              	</div>
