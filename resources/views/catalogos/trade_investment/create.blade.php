    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.trade_investment.create_trade')</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            @endif
                            <form class="form-horizontal"  method="POST" action="{{url('trade_investment')}}" id="frm_transactions" onsubmit="return validateFrm();">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputticket">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" autocomplete="off" tabindex="1" maxlength="8" onkeypress="return isNumber(event)" class="form-control" id="ticket" name="ticket" placeholder="{{__('sistema.transaction.ticket')}}" valida="SI" cadena ="{{__('sistema.transaction.req_ticket')}}" value="{{ (old('ticket'))? old('ticket'): $token_number }}">
                                                <input type="hidden" value="0" name="is_opening" id="is_opening"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputinstrument_id">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="3" class="form-control select2" id="instrument_id" name="instrument_id" valida="SI" cadena ="{{__('sistema.transaction.req_instrument')}}">
                                                    <option value="">@lang('sistema.transaction.select_instrument')</option>
                                                    @foreach($instruments as $key=>$instrument)
                                                        <option value="{{ $key }}" {{ old('instrument_id') == $key ? 'selected' : '' }}>{{ $instrument }}</option>
                                                    @endforeach
                                                </select>                                                
                                            </div>
                                        </div>
                                ...
                                <div class="row">   
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputfecha">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="4" type="text" autocomplete="off" class="form-control date_picker" id="fecha" name="fecha" placeholder="{{__('sistema.trade_investment.fecha')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_fecha')}}" value="{{ (old('fecha'))? old('fecha'):'' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputfecha_vencimiento">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="5" type="text" autocomplete="off" class="nonopening form-control date_picker2" id="fecha_vencimiento" name="fecha_vencimiento" placeholder="{{__('sistema.trade_investment.fecha_vencimiento')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_fecha_vencimiento')}}" value="{{ (old('fecha_vencimiento'))? old('fecha_vencimiento'):'' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputtransaction">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="6" type="text" autocomplete="off" class="nonopening form-control" id="transaction" name="transaction" placeholder="{{__('sistema.trade_investment.transaction')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_transaction')}}" value="{{ (old('transaction'))? old('transaction'):'' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputmonto">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="7" type="text" autocomplete="off" class="form-control autonumber" id="monto" name="monto" placeholder="{{__('sistema.trade_investment.monto')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_monto')}}" value="{{ (old('monto'))? old('monto'): '' }}">
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputprecio">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="8" type="text" autocomplete="off" class="nonopening form-control autonumber" id="precio" name="precio" placeholder="{{__('sistema.trade_investment.precio')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_precio')}}" value="{{ (old('precio'))? old('precio'): '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputnav">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="9" autocomplete="off" type="text" class="nonopening1 form-control autonumber" id="nav" name="nav" placeholder="{{__('sistema.trade_investment.nav')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_nav')}}" value="{{ (old('nav'))? old('nav'): '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputriesgo">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="10" type="text" autocomplete="off" class="nonopening form-control autonumber2" id="riesgo" name="riesgo" placeholder="{{__('sistema.trade_investment.riesgo')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_riesgo')}}" value="{{ (old('riesgo'))? old('riesgo'): '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputcontratos">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="11" type="text" autocomplete="off" class="nonopening form-control autonumber" id="contratos" name="contratos" placeholder="{{__('sistema.trade_investment.contratos')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_contratos')}}" value="{{ (old('contratos'))? old('contratos'): '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputexposicion">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="12" readonly autocomplete="off" type="text" class="nonopening1 form-control autonumber" id="exposicion" name="exposicion" placeholder="{{__('sistema.trade_investment.exposicion')}}" valida="SI" cadena ="{{__('sistema.trade_investment.req_exposicion')}}" value="{{ (old('exposicion'))? old('exposicion'): '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    /* Ajax call on Account change intrument change*/
    function ajax_call()
    {
        let account_id = $('#account_number').val();
        let instrument_id = $('#instrument_id').val();
        if (account_id != '' && instrument_id != '')
        {
            show_loader(true);
            $.ajax({
                type: 'GET',
                dataType: 'json',
                data: {},
                url: "{{ url('accounts') }}/" + account_id + '/'+ instrument_id +'/check_trade',
                beforeSend: function () {
                ...
                success: function (response) {
                    if (response.flag == 1) {
                        ...
                        $("#is_opening").val(is_opening_balance);
                        $('.date_picker').datepicker('setStartDate', new Date(response.mindate));                        
    ...
    function check_opening_balance()
    {
        if (is_opening_balance == 1)
        {
            ...
            $("#precio, #nav, #riesgo, #contratos, #exposicion, #fecha_vencimiento").attr('valida', 'NO');
        ...
        } else
        {
            ...
            $("#precio, #nav, #riesgo, #contratos, #exposicion, #fecha_vencimiento").val('');
            $(".date_picker2").datepicker('setDate', $('.date_picker').datepicker('getDate'));
        }
        validateFrm(false);
    }
</script>
