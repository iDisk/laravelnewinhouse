...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.leverage.leverages')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('leverages/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.leverage.new_leverage')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="leverage-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.leverage.label')</th>
                                        <th>@lang('sistema.leverage.calc_value')</th>
...
<script type="text/javascript">
    ...
    function confirmaDel(id,text)
    {
        swal({
            ...
            text: "{{ __('sistema.leverage.delete_msg') }} :\""+text+'\"?',
            type: "warning",
    ...
    $(function() {
        leverage_tbl = $('#leverage-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{!! url("datatable/leverages") !!}',
                data: function (d) {
            ...
            columns: [
                ...
                { data: 'calc_value', name: 'calc_value' },
