	...
	<div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.leverage.create_leverage')</h4>
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active">
                        @lang('sistema.leverage.create_leverage')
                    </li>
                </ol>
                  	...
                  	<div class="row">
                      	<div class="col-lg-6">
                          	@if (count($errors) > 0)
                           	...
                           	@endif
                          	<form class="form-horizontal"  method="POST" action="{{url('leverages')}}" id="frm_leverages" onsubmit="return validateFrm();">
                              	{{ csrf_field() }}
                              	<div class="form-group row" id="inputlabel">
                        	      	...
                        	      	<div class="col-sm-9">
                                      	<input type="text" class="form-control" id="label" name="label" placeholder="{{__('sistema.leverage.label')}}" valida="SI" cadena ="{{__('sistema.leverage.req_label')}}" value="{{ (old('label'))? old('label'):'' }}">
                                    </div>
                              	</div>
                              	<div class="form-group row" id="inputcalc_value">
                        	      	...
                        	      	<div class="col-sm-9">
                                      	<input type="text" class="form-control" id="calc_value" name="calc_value" placeholder="{{__('sistema.leverage.calc_value')}}" valida="SI" cadena ="{{__('sistema.leverage.req_calc_value')}}" value="{{ (old('calc_value'))? old('calc_value'):'' }}">
                                   	</div>
                              	</div>
