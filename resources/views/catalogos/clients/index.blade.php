...
<div class="container-fluid">
	<div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.client.accounts')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('clients/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.client.new_account')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="questions-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.client.acc_number')</th>
                                        <th>@lang('sistema.equity_report.customer')</th>
                                        <th>@lang('sistema.client.type_of_acc')</th>
                                        <th>@lang('sistema.client.opening_amount')</th>
                                        <th>@lang('sistema.client.date_of_transfer')</th>
...
<script type="text/javascript">
    ...
    $(function() {
      	question_tbl = $('#questions-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{!! url("datatable/clients") !!}',
                data: function (d) {
            ...
            columns: [
              	...
              	{ data: 'opening_amount', name: 'opening_amount', class: 'text-right', render: function(data){
                    return '$' + data;
                }},
                { data: 'date_of_transfer', name: 'date_of_transfer' },
