                                  ...
                                  <form class="form-horizontal"  method="POST" action="{{url('clients/'.$account->id)}}" id="frm_clients" enctype="multipart/form-data" onsubmit="return validateFrm();">
                                          ...
                                          <div class="col-sm-9">
                                              <select class="form-control" placeholder="{{__('sistema.client.financial_service')}}"  valida="SI" cadena ="{{__('sistema.client.financial_service_valid')}}" name="account_instruments[]" id="account_instruments" multiple="multiple">
                                                  @foreach($financial_services as $key=>$value)
                                                      <option value="{{ $key }}" {{ (in_array($key,$account_instruments))?'selected':'' }}>{{ $value}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
                                            ...
                                            <div class="form-group col-lg-6 row m-0" id="inputbranch_id">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="branch_id" name="business_detail[branch_id]" valida="SI" cadena ="{{__('sistema.branches.req_branch')}}">
                                                        ...
                                                        <option value="{{ $branch_id }}" {{ old('branch_id') == $branch_id ? 'selected' : ($business_detail->branch_id == $branch_id ? 'selected' : '') }}>{{ $branch_name }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="form-group col-lg-6 row m-0" id="inputbranch_id">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" id="branch_id" name="client[branch_id][]" valida="SI" cadena ="{{__('sistema.branches.req_branch')}}">
                                                                ...
                                                                @if(isset($branches) && count($branches)>0)
                                                                @foreach($branches as $branch_id => $branch_name)
                                                                <option value="{{ $branch_id }}" {{ old('branch_id') == $branch_id ? 'selected' : ($client->branch_id == $branch_id ? 'selected' : '') }}>{{ $branch_name }}</option>
                                                                @endforeach
                                                                @endif
                                                            </select>
                                                        </div>
                                    ...
                                    <div class="form-group col-lg-12 row">
                                        <div class="form-group col-lg-6 row m-0" id="inputtransfer_internal_account">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control autonumber" id="transfer_internal_account" name="account[transfer_internal_account]" valida="SI" cadena="{{__('sistema.client.transfer_internal_account')}}" value="{{ $account->transfer_internal_account }}"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 row m-0" id="inputtransfer_third_party_account">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control autonumber" id="transfer_third_party_account" name="account[transfer_third_party_account]" valida="SI" cadena="{{__('sistema.client.transfer_third_party_account')}}" value="{{ $account->transfer_third_party_account }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-12 row">
                                        <div class="form-group col-lg-6 row m-0" id="inputtransfer_international_account">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control autonumber" id="transfer_international_account" name="account[transfer_international_account]" valida="SI" cadena="{{__('sistema.client.transfer_international_account')}}" value="{{ $account->transfer_international_account }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Daily Limit End -->                                    
                                    ...
                                    <div style="display: none;">
                                        ...
                                        <div class="form-group col-lg-12 row">
                                            <div class="form-group col-lg-6 row m-0">
                                                <div class="radio">
                                                    <label for="opt1">
                                                        <input type="radio" name="account[opt_notification]" value="1" id="opt1" {{ $account->opt_notification ? 'checked' : '' }}>
                                                        <span class="cr"><i class="cr-icon mdi mdi-checkbox-blank-circle"></i></span>
                                                        @lang('sistema.client.yes')
                                                    </label>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <label for="opt0">
                                                        <input type="radio" name="account[opt_notification]" value="0" id="opt0"  {{ !$account->opt_notification ? 'checked' : '' }}>
                                                        <span class="cr"><i class="cr-icon mdi mdi-checkbox-blank-circle"></i></span>
