...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.commission_fee.commission_fees')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('commission_fees/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.commission_fee.new_commission_fee')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="item-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.commission_fee.commission_fee')</th>
...
<script type="text/javascript">
    ...
    function confirmaDel(id,text)
    {
        swal({
            ...
            text: "{{ __('sistema.commission_fee.delete_msg') }} :\""+text+'\"?',
            type: "warning",
    ...
    $(function() {
        item_tbl = $('#item-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! url("datatable/commission_fees") !!}',
                data: function (d) {
            ...
            columns: [
                { data: 'id', name: 'id' },
                { data: 'commission_fee',name: 'commission_fee'},
