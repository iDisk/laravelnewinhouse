	...
	<div class="row">
        <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('sistema.commission_fee.create_commission_fee')</h4>
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active">
                            @lang('sistema.commission_fee.create_commission_fee')
                        </li>
                    </ol>
                  	...
                  	<div class="row">
                      	<div class="col-lg-6">
                          	@if (count($errors) > 0)
                           	...
                           	@endif
                          	<form class="form-horizontal"  method="POST" action="{{url('commission_fees')}}" id="frm_commission_fees" onsubmit="return validateFrm();" enctype="multipart/form-data">
                          		...
                          		<div class="form-group row" id="inputcommission_fee">
                        	      	...
                        	      	<div class="col-sm-9">
                                        <div class="input-group">
                                      	   <input type="text" class="form-control" id="commission_fee" name="commission_fee" placeholder="{{__('sistema.commission_fee.commission_fee')}}" valida="SI" cadena ="{{__('sistema.commission_fee.req_commission_fee')}}" value="{{ (old('commission_fee'))? old('commission_fee'):'' }}">
