    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.transaction.edit_transaction')</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            @endif
                            <form class="form-horizontal"  method="POST" action="{{url('transactions/'.$transaction->id)}}" id="frm_transactions" onsubmit="return validateFrm();">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputticket">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="1" type="text" maxlength="8" onkeypress="return isNumber(event)" class="form-control" id="ticket" name="ticket" placeholder="{{__('sistema.transaction.ticket')}}" valida="SI" cadena ="{{__('sistema.transaction.req_ticket')}}" value="{{ $transaction->ticket }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!--                              		<div class="col-lg-6">
                                                                                    <div class="form-group row" id="inputinitial_capital">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                            <input type="text" class="form-control autonumber" id="initial_capital" name="initial_capital" placeholder="{{__('sistema.transaction.initial_capital')}}" valida="SI" cadena ="{{__('sistema.transaction.req_initial_capital')}}" value="{{ $transaction->initial_capital }}" data-v-min="000000.00" data-v-max="999999.99">
                                                                                            </div>
                                                                                    </div>
                                                                            </div>-->
                                    <div class="col-lg-6">
                                        <div class="form-group row" id="inputaccount_number">
                                            ...
                                            <div class="col-sm-9">                                                
                                                <input type="text" tabindex="2" class="form-control" id="account_number" name="account_number" placeholder="{{__('sistema.transaction.account_number')}}" valida="SI" cadena ="{{__('sistema.transaction.req_account_number')}}" value="{{ $account->account_number }}{{ $account->primary_client ? ' - ' . $account->primary_client->full_name : '' }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row" id="inputtype">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="3" id="type" class="form-control" name="type" valida="SI" cadena="{{__('sistema.transaction.req_type')}}">
                                                    ...
                                                    <option value="{{ $key }}" {{ ($key == $transaction->transaction_type_id)? 'selected':'' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" id="inputinstrument">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="4" id="instrument" class="form-control" name="instrument" valida="SI" cadena="{{__('sistema.transaction.req_instrument')}}">
                                                    ...
                                                    <option value="{{ $key }}" {{ ($key == $transaction->instrument_id)? 'selected':'' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" id="inputitem">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="5" id="item" class="form-control" name="item" valida="SI" cadena="{{__('sistema.transaction.req_item')}}">
                                                    ...
                                                    <option value="{{ $key }}" {{ ($key == $transaction->item_id)? 'selected':'' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row" id="inputopening_date">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="6" type="text" class="form-control date_picker" id="opening_date" name="opening_date" placeholder="{{__('sistema.transaction.opening_date')}}" valida="SI" cadena ="{{__('sistema.transaction.req_opening_date')}}" value="{{ \Carbon\Carbon::parse($transaction->opening_date)->format('d/m/Y') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputopening_time">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="8" type="text" class="form-control timepicker" id="opening_time" name="opening_time" placeholder="{{__('sistema.transaction.opening_time')}}" valida="SI" cadena ="{{__('sistema.transaction.req_opening_time')}}" value="{{ $transaction->opening_time }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputopening_price">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="10" type="text" class="form-control autonumber" id="opening_price" name="opening_price" placeholder="{{__('sistema.transaction.opening_price')}}" valida="SI" cadena ="{{__('sistema.transaction.req_opening_price')}}" value="{{ $transaction->opening_price }}" data-v-min="000000.000000" data-v-max="999999.999999">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" id="inputleverage">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="14" id="leverage" class="form-control" name="leverage" valida="SI" cadena="{{__('sistema.transaction.req_leverage')}}">
                                                    ...
                                                    <option value="{{ $key }}" {{ ($key == $transaction->leverage_id)? 'selected':'' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="leverage_tmp" id="leverage_tmp" value="{{ $leverage_calc_value->calc_value }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputfinancial_exhibition">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="16" type="text" class="form-control autonumber" id="financial_exhibition" name="financial_exhibition" placeholder="{{__('sistema.transaction.financial_exhibition')}}" valida="SI" cadena ="{{__('sistema.transaction.req_financial_exhibition')}}" value="{{ $transaction->financial_exhibition }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputstop_loss">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="18" type="text" class="form-control autonumber" id="stop_loss" name="stop_loss" placeholder="{{__('sistema.transaction.stop_loss')}}" valida="SI" cadena ="{{__('sistema.transaction.req_stop_loss')}}" value="{{ $transaction->stop_loss }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputcontracts">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="20" type="text" class="form-control autonumber" id="contracts" name="contracts" placeholder="{{__('sistema.transaction.contracts')}}" valida="SI" cadena ="{{__('sistema.transaction.req_contracts')}}" value="{{ $transaction->contracts }}" data-v-min="0" data-v-max="9999999">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputfacial_value">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="22" type="text" class="form-control autonumber" id="facial_value" name="facial_value" placeholder="{{__('sistema.transaction.facial_value')}}" valida="SI" cadena ="{{__('sistema.transaction.req_facial_value')}}" value="{{ $transaction->facial_value }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputwarranty">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="24" type="text" class="form-control autonumber" id="warranty" name="warranty" placeholder="{{__('sistema.transaction.warranty')}}" valida="SI" cadena ="{{__('sistema.transaction.req_warranty')}}" value="{{ $transaction->warranty }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row" id="inputclosing_date">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="7" type="text" class="form-control date_picker" id="closing_date" name="closing_date" placeholder="{{__('sistema.transaction.closing_date')}}" valida="SI" cadena ="{{__('sistema.transaction.req_closing_date')}}" value="{{ \Carbon\Carbon::parse($transaction->closing_date)->format('d/m/Y') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputclosing_time">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="9" type="text" class="form-control timepicker" id="closing_time" name="closing_time" placeholder="{{__('sistema.transaction.closing_time')}}" valida="SI" cadena ="{{__('sistema.transaction.req_closing_time')}}" value="{{ $transaction->closing_time }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputclosing_price">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="11" type="text" class="form-control autonumber" id="closing_price" name="closing_price" placeholder="{{__('sistema.transaction.closing_price')}}" valida="SI" cadena ="{{__('sistema.transaction.req_closing_price')}}" value="{{ $transaction->closing_price }}" data-v-min="000000.000000" data-v-max="999999.999999">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputconversion_closing">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="13" type="text" class="form-control autonumber" id="conversion_closing" name="conversion_closing" placeholder="{{__('sistema.transaction.conversion_closing')}}" valida="SI" cadena ="{{__('sistema.transaction.req_conversion_closing')}}" value="{{ $transaction->conversion_closing }}" data-v-min="000000.000000" data-v-max="999999.999999">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputspread">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="15" type="text" class="form-control autonumber" id="spread" name="spread" placeholder="{{__('sistema.transaction.spread')}}" valida="SI" cadena ="{{__('sistema.transaction.req_spread')}}" value="{{ $transaction->spread }}" readonly >
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputcommission_fee">
                                            ...
                                            <div class="col-sm-9">
                                                <select tabindex="17" id="commission_fee" class="form-control" name="commission_fee" valida="SI" cadena="{{__('sistema.transaction.req_commission_fee')}}">
                                                    ...
                                                    <option value="{{ $key }}" {{ ($key == $transaction->commission_fee_id)? 'selected':'' }}>{{ $value }}%</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputcommission">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="19" type="text" class="form-control autonumber" id="commission" name="commission" placeholder="{{__('sistema.transaction.commission')}}" valida="SI" cadena ="{{__('sistema.transaction.req_commission')}}" value="{{ $transaction->commission }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputgross_profit">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="21" type="text" class="form-control autonumber" id="gross_profit" name="gross_profit" placeholder="{{__('sistema.transaction.gross_profit')}}" valida="SI" cadena ="{{__('sistema.transaction.req_gross_profit')}}" value="{{ $transaction->gross_profit }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="inputnet_result">
                                            ...
                                            <div class="col-sm-9">
                                                <input tabindex="23" type="text" class="form-control autonumber" id="net_result" name="net_result" placeholder="{{__('sistema.transaction.net_result')}}" valida="SI" cadena ="{{__('sistema.transaction.req_net_result')}}" value="{{ $transaction->net_result }}" readonly>
                                            </div>
                                        </div>
                                        <!--		                              	<div class="form-group row" id="inputfinal_capital_client">
                                                                                                ...
                                                                                                <div class="col-sm-9">
                                                                                                <input type="text" class="form-control" id="final_capital_client" name="final_capital_client" placeholder="{{__('sistema.transaction.final_capital_client')}}" valida="SI" cadena ="{{__('sistema.transaction.req_final_capital_client')}}" value="{{ $transaction->final_capital_client }}" readonly>
                                                                                                </div>
                                                                                        </div>-->
                                    </div>
                                </div>
