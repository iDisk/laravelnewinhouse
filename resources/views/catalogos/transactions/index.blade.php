...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.trade.trade')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">                    
                    <a href="{{ url('transactions/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.trade.new_trade')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="transactions-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('sistema.transaction.ticket')</th>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        table_transactions = $('#transactions-table').DataTable({
            ...
            order: [[ 7, "desc" ]],
            ajax: {
                url: '{!! url("datatable/transactions") !!}',
                data: function (d) {
