                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            @endif
                            <form class="form-horizontal"  method="POST" action="{{url('estatus/' . $estatus->id)}}" id="frm_items" onsubmit="return validateFrm();">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row" id="inputstatus_en">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" maxlength="25" class="form-control" id="status_en" name="status_en" placeholder="{{__('sistema.estatus.estatus_en')}}" valida="SI" cadena ="{{__('sistema.estatus.required.estatus_en')}}" value="{{ (old('status_en')) ? old('status_en') : $estatus->status_en }}">
                                    </div>
                                </div>
                                <div class="form-group row" id="inputstatus_es">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" maxlength="25" class="form-control" id="status_es" name="status_es" placeholder="{{__('sistema.estatus.estatus_en')}}" valida="SI" cadena ="{{__('sistema.estatus.required.estatus_es')}}" value="{{ (old('status_es')) ? old('status_es') : $estatus->status_es }}">
                                    </div>
                                </div>
                                <div class="form-group row" id="inputcolor_code">
                                    ...
                                    <div class="col-sm-6">
                                        <div data-color-format="rgb" data-color="{{ $estatus->color_code }}" class="colorpicker-default input-group">
                                            <input type="text" readonly="readonly" value="" name="color_code" id="color_code" class="form-control color_input" valida="SI" cadena ="{{__('sistema.estatus.required.color_code')}}" value="{{ old('color_code') ? : $estatus->color_code }}">
                                            <span class="input-group-append add-on color_button">
                                                <button class="btn btn-white" type="button">
                                                    <i style="background-color: {{ $estatus->color_code }};margin-top: 2px;"></i>
                                                </button>
                                            </span>
                                        </div>
                                    </div>                                    
                                ...
                                <div class="form-group row" id="inputmenu_orientation" >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio custom-control-inline mb-2">
                                            <input type="radio" id="status_active" name="active" value="1" class="custom-control-input" {{ $estatus->active ? 'checked' : ''}}>
                                            <label class="custom-control-label" for="status_active">@lang('sistema.active')</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline mb-2">
                                            <input type="radio" id="status_inactive" name="active" value="0" class="custom-control-input" {{ !$estatus->active ? 'checked' : ''}}>
