        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('sistema.security_image.edit_security_image')</h4>
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active">
                            @lang('sistema.security_image.edit_security_image')
                        </li>
                    </ol>
		         	...
		         	<div class="card-body">
		              	...
		              	<div class="row">
		                  	<div class="col-lg-6">
                                ...
                                @endif
		                  		<form class="form-horizontal"  method="POST" action="{{url('security_images/'.$security_image->id)}}" id="frm_security_images" onsubmit="return validateFrm();" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row" id="inputphoto">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" class="filestyle" data-buttonname="btn-primary" data-buttontext="{{__('sistema.validate_user.photo')}}"  id="photo" name="photo" placeholder="{{__('sistema.security_image.image')}}">
                                            <br>
                                            <img class="img-responsive m-t-10" src="{{ $security_image->image }}" width="200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" id="inputorder">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="order" name="order" placeholder="{{__('sistema.security_image.order')}}" valida="SI" cadena ="{{__('sistema.security_image.order_requiredval')}}" value="{{ $security_image->order }}">
                                        </div>
                                    </div>
