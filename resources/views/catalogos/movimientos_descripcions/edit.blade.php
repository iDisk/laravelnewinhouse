        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('sistema.movimientos_desc.edit_movimientos_desc')</h4>
		         	...
		         	<div class="card-body">
		              	...
		              	<div class="row">
		                  	<div class="col-lg-6">
                                ...
                                @endif
		                  		<form class="form-horizontal"  method="POST" action="{{url('movimientos_descripcions/'.$movimientos_tipo->id)}}" id="frm_movimientos_descripcions" onsubmit="return validateFrm();">
                                    ...
                                    <div class="form-group row" id="inputdescription_en">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="description_en" name="description_en" placeholder="{{__('sistema.movimientos_desc.description_en')}}" valida="SI" cadena ="{{__('sistema.movimientos_desc.req_description_en')}}" value="{{ $movimientos_tipo->description_en }}">
                                          </div>
                                    </div>
                                    <div class="form-group row" id="inputdescription_es">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="description_es" name="description_es" placeholder="{{__('sistema.movimientos_desc.description_es')}}" valida="SI" cadena ="{{__('sistema.movimientos_desc.req_description_es')}}" value="{{ $movimientos_tipo->description_es }}">
                                          </div>
                                    </div>
