...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">@lang('sistema.movimientos_desc.movimientos_descriptions')</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('movimientos_descripcions/create') }}" class="btn btn-success waves-effect waves-light pull-right m-b-10"><span class="glyphicon glyphicon-check"></span> @lang('sistema.movimientos_desc.new_movimientos_desc')</a>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="movimientos_tipo-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>@lang('sistema.movimientos_desc.description_en')</th>
                                        <th>@lang('sistema.movimientos_desc.description_es')</th>
...
<script type="text/javascript">
    ...
    function confirmaDel(id,text)
    {
        swal({
            ...
            text: "{{ __('sistema.movimientos_desc.delete_msg') }} :\""+text+'\"?',
            type: "warning",
    ...
    var movement_desc_tbl;
    //Aqui deben de ir las secciones adicionales
    $(function() {
        movement_desc_tbl = $('#movimientos_tipo-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{!! url("datatable/movimientos_descripcions") !!}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'description_es', name: 'description_es' },
