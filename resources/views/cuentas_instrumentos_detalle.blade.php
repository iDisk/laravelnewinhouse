        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 center-page">
                <div class="text-right m-b-5">
                    <a class="text-aqua-blue font-600 text-underline p-l-r-5" href="{{ url($listing_url) }}">@lang('frontsistema.return')</a>
                </div>
                    ...
                    @if($type == 'mov')
                        <div class="card-body">
                            <div class="text-center11">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.ticket'):</span> {{ $movimientos_transaction->ticket }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.date'):</span> {{ date("d-m-Y", strtotime($movimientos_transaction->fecha_transaccion)) }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.type'):</span> {{ $movimientos_transaction->type }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.description'):</span> {{ $movimientos_transaction->description }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.net_pl'):</span> {{ ($movimientos_transaction->operation_category == 1)?'':'-' }}{{ number_format($movimientos_transaction->monto, 2, '.', ',') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
