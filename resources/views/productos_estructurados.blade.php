        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('frontsistema.trade_investment.structured_products')</h4>
                    <div class="web_logo">
                            ...
                            <tbody>
                                ...
                                @foreach($tarde_investments as $tarde_investment)
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="color_green" href="{{ url('user/productos_estructurados_detail/'.App\Util\HelperUtil::encode($tarde_investment->id)) }}">@lang('frontsistema.trade_investment.view_complete')</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
