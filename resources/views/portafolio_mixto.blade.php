                            ...
                            <tbody>
                                ...
                                @foreach($tarde_investments as $tarde_investment)
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="color_green" href="{{ url('user/portafolio_mixto_detail/'.App\Util\HelperUtil::encode($tarde_investment->id)) }}">@lang('frontsistema.trade_investment.view_complete')</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
