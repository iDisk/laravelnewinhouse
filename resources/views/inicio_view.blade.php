                    ...
                    @if($type == 'trade')
                        <div class="card-body">
                            <div class="text-center11">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.stop_loss'):</span> {{ number_format($account_transaction->stop_loss, 2, '.', ',') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.warranty'):</span> {{ number_format($account_transaction->warranty, 2, '.', ',') }}</p>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    @elseif($type == 'mov')
                        <div class="card-body">
                            <div class="text-center11">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="m-t-5 m-b-0"><span class="font-700">@lang('frontsistema.derivados_etim_cfds_fx.net_pl'):</span> {{ number_format($movement_transaction->monto, 2, '.', ',') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
