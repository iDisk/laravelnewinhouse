                                ...
                                @foreach($results as $result)
                                    ...
                                    <tr>
                                        ...
                                        @if($result->trans_type == 1)
                                            <td></td>
                                            <td>{{ $sign }}{{ number_format($result->monto, 2, '.', ',') }}</td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <td><a class="color_green" href="{{ url('user/mis_cuentas_instrumentos/'.$type.'/'.App\Util\HelperUtil::encode($result->id)) }}">@lang('frontsistema.trade_investment.view_complete')</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
