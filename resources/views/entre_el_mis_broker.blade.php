    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-title-box text-xs-center text-sm-center text-md-center">
                    <h4 class="page-title">@lang('frontsistema.entre_el_mis_broker.title')</h4>
                    <div class="web_logo">
            ...
            <div class="col-xl-12 p-l-xs-30">
                <div id="basic-form" action="#">
                    <div>
                        <h3>
                            <span class="text">
                                @lang('frontsistema.entre_el_mis_broker.first_main_title')</h3>
                            </span>
                        </h3>
                        <section>
                            <form id="first_form" name="first_form">
                                <div class="row m-b-10 m-t-xs-15 on_load">
                                    <div class="col-xl-4 offset-xl-4 offset-xs-4 col-lg-4 offset-lg-4 col-md-8 offset-md-2 text-center">
                                        <p class="m-0 font-600">@lang('frontsistema.entre_el_mis_broker.saldo_label')</p>
                                ...
                                <div class="row on_load">
                                    <div class="col-xl-4 offset-xl-4 offset-xs-4 col-lg-4 offset-lg-4 col-md-8 offset-md-2 text-center">
                                        <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.charge_account')<sup>*</sup></label>
                                        ...
                                        <div class="form-error">@lang('frontsistema.entre_el_mis_broker.charge_account_error')</div>
                                    </div>
                                </div>
                                <div class="row m-t-50">
                                    <div class="col-12">
                                        <h5 class="font-16 font-600">@lang('frontsistema.entre_el_mis_broker.first_title')</h5>
                                        <div class="row m-b-30 on_load">
                                            <div class="col-xl-4 col-lg-4 col-md-6 m-t-minus-5 m-t-sm-5 m-t-xs-5 m-t-20">
                                                <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.badge_label')<sup>*</sup></label>
                                                ...
                                                <div class="form-error">@lang('frontsistema.entre_el_mis_broker.badge_error')</div>
                                            </div>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 m-t-minus-5 m-t-sm-15 m-t-xs-15 m-t-20">
                                                <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.amount_label')<sup>*</sup></label>
                                                ...
                                                <div class="form-error">@lang('frontsistema.entre_el_mis_broker.amount_label_error')</div>
                                            </div>
                                            <div class="col-xl-4 col-lg-4 col-md-6 m-t-minus-5 m-t-sm-15 m-t-xs-15 m-t-20">
                                                <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.application_date')</label>
                                                ...
                                                <div class="form-error">@lang('frontsistema.entre_el_mis_broker.application_date_err')</div>
                                            </div>
                                            <div class="col-xl-4 col-lg-4 col-md-6 m-t-minus-5 m-t-sm-15 m-t-xs-15 m-t-20">
                                                <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.payment_account')<sup>*</sup></label>
                                                <select class="form-control input-black" type="text" id="payment_account" name="payment_account" data-parsley-trigger="change" required guardar="SI">
                                                    ...
                                                    @foreach($user_other_accounts as $user_other_account)
                                                        <option value="{{ $user_other_account->dest_account_number.' - '.$user_other_account->first_name.' - '.$user_other_account->instrument }}">{{ $user_other_account->dest_account_number.' - '.$user_other_account->first_name.' - '.$user_other_account->instrument }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="form-error">@lang('frontsistema.entre_el_mis_broker.payment_account_error')</div>
                                            </div>
                                            <div class="col-xl-4 offset-xl-4 col-lg-4 offset-lg-4 text-right m-t-20">
                                                <label class="m-0 font-600 font-11">&nbsp;</label>
                                                <button class="btn btn-block btn-aqua-blue waves-effect waves-light" type="submit">@lang('frontsistema.entre_el_mis_broker.add_registration')</button>
                                            </div>
                                            <!-- end col -->
                                        </div>
                                        <div class="row m-t-10 m-b-30">
                                            <div class="col-xl-12">
                                                <h5 class="font-16">@lang('frontsistema.entre_el_mis_broker.required_help')</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section>
                            <form id="second_form" name="second_form">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="font-16 font-600">@lang('frontsistema.entre_el_mis_broker.second_title')</h5>
                                        <div class="row on_load verification_head">
                                            <div class="col-xl-12 m-t-30 col-lg-12 col-md-12 text-center text-lg-left text-md-left custom-text-sm-left text-xs-left">
                                                <span class="title">
                                                    @lang('frontsistema.entre_el_mis_broker.user_label')
                                                </span>
                                                {{$accountName}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-error verificationError">@lang('frontsistema.entre_el_mis_broker.verification_error')</div>
                                        <div class="row m-t-30 m-b-30">
                                            <div class="col-xl-12 text-right">
                                                ...
                                                <button class="btn btn-aqua-blue waves-effect waves-light" type="submit">@lang('frontsistema.entre_el_mis_broker.submit_label')</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form id="third_form" name="third_form">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <h5 class="font-16 font-600">@lang('frontsistema.entre_el_mis_broker.third_title')</h5>
                                        ...
                                        <h5 class="font-16">@lang('frontsistema.entre_el_mis_broker.code_label')</h5>
                                        <div class="row on_load">
                                            <div class="col-xl-4 col-lg-6 col-md-6 m-t-minus-5 m-t-sm-15 m-t-xs-15 m-t-20">
                                                <label class="m-0 font-600 font-11">@lang('frontsistema.entre_el_mis_broker.code')</label>
                                                ...
                                                <div class="form-error">@lang('frontsistema.entre_el_mis_broker.code_error')</div>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-md-6 m-t-minus-5 m-t-sm-15 m-t-xs-15 m-t-20">
                                                <label class="m-0 font-600 font-11">&nbsp;</label>
                                                <button class="btn btn-block btn-aqua-blue waves-effect waves-light">@lang('frontsistema.entre_el_mis_broker.submit_label')</button>
                                            </div>
                                        </div>
                                        <div class="row m-b-30 on_load">
                                            <div class="col-xl-4 col-lg-6">
                                                <a class="text-aqua-blue m-r-10 cursor-pointer line-height-35 resendOtp" href="javascript:void(0)">@lang('frontsistema.entre_el_mis_broker.request_another_code')</a>
                                            </div>
                                            <div class="col-xl-4 col-lg-6">
                                        ...
                                        <div class="row on_load">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <h5 class="font-16">
                                                    @lang('frontsistema.entre_el_mis_broker.help_msg3')
                                                    <a href="javascript:void(0)" class="open_contact_us_form blue">@lang('frontsistema.entre_el_mis_broker.contact')</a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row on_success m-t-50" style="display: none;">
            <div class="col-lg-12 text-center">
                <h3 class="font-600">@lang('frontsistema.entre_el_mis_broker.success_msg_title')</h3>
                <p class="text-custom-info font-600 font-16 m-b-0 m-t-20">@lang('frontsistema.entre_el_mis_broker.success_msg')</p>
                <div class="row m-t-20">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 text-right text-md-center text-sm-center text-xs-center">
                        <a class="text-aqua-blue m-r-10 cursor-pointer line-height-35" href="{{ route('client_home') }}">@lang('frontsistema.entre_el_mis_broker.back_to_home')</a>
                    </div>
                    <div class=" col-lg-6 col-md-12 col-sm-12 col-xs-12 text-left text-md-center text-sm-center text-xs-center">
                        <button id="submit-another-request" class="btn btn-aqua-blue waves-effect waves-light">@lang('frontsistema.entre_el_mis_broker.request_more_finance')</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{ url('assets/pages/jquery.wizard-init.js') }}" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        function initParsleyValidation() {
            ...
            .on('form:submit', function () {
                ...
                if ($('#from_account').val() == $('#payment_account').val()) {
                    swal("@lang('frontsistema.users_alert')", "@lang('frontsistema.entre_el_mis_broker.same_account_error')", 'error');
                }
                else {
        ...
        $('body').on('change', '#from_account', function() {
            if($('#from_account').val()) {
                //$('#saldoBalance').html('$ ' + $("#from_account option:selected").data('saldo'));
        ...
        function submitFirstForm(){
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                data: {'_token':token,'text':req_data,'request_type_id':42,'verify':2,'from':'Transferencias entre el mismo broker'},
                ...
                success: function(response) {
                    if (response.error && response.code == '500'){
                        ...
                        $.ajax({
                            type: 'GET',
                            dataType: 'json',
                            url: "{{ url('user/pending_internal_broker_transfers') }}" + '?_token=' + token + '&user_id=' + '{{$user_id}}' + '&account_id=' + '{{$payment_accounts[0]["id"]}}',
                            success: function(response) {
                                if (response.error && response.code == '500'){
                                    show_loader(false);
                                }
        ...
        function submitSecondForm(){
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                data: {'_token':token,'request_type_id':42,'client_request_id': pending_requests[selectedIndex].id},
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error && response.code == '500'){
                        ...
                        // Reset all the forms and show success dialog
                        swal("@lang('frontsistema.users_alert')", "@lang('frontsistema.entre_el_mis_broker.otp_resent')", 'success');
                    }
                },
                error: function(response) {
                    //console.error(response);
        ...
        $('body').on('click', '.deleteVerification', function() {
            ...
            swal({
                ...
                text: "{{ __('frontsistema.entre_el_mis_broker.request_del_confirm') }}",
                type: "warning",
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.error && response.code == '500'){
                            ...
                            // Reset all the forms and show success dialog
                            swal("@lang('frontsistema.users_alert')", "@lang('frontsistema.entre_el_mis_broker.request_deleted')", 'success');
